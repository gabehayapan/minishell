...
// handle_input/parser/expansion/expand_specials.c
...
// handle_input/parser/expansion/history/history_substitution.c
int			check_history(t_token **tokens, t_his *his);

// handle_input/parser/expansion/history/history_utils.c
void		insert_token(t_token *head, t_token *new);

// handle_input/parser/expansion/history/history_single.c
...
// handle_input/parser/expansion/replace_command.c
...
// handle_input/parser/expansion/wildcard/wildcard_expansion.c
int			wildcard_expansion(t_token **tokens);

// handle_input/parser/expansion/wildcard/wildcard_init.c
int			init_wildcard(t_token **filter, t_token **token_dir, t_dir *dnames);
int			replace_token_word(char **word, char *new_word);

// handle_input/parser/expansion/wildcard/wildcard_init_slash.c
...
// handle_input/parser/expansion/wildcard/wildcard_get_dirent.c
...
// handle_input/parser/expansion/wildcard/wildcard_expansion_utils.c
